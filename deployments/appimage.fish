...
echo "Linux deployment script for LabStreamGate"

# test current directory is end with LabStreamGate
if not string match -q -r 'LabStreamGate$' (pwd)
    echo "Please run this script in the LabStreamGate directory"
    exit 1
end
