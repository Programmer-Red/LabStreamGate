        ...
        .child(
            ...
            settings_row(
                ...
                Button::new("version")
                    ...
                    .on_click(|_, _, _| {
                        RootView::open_link(
                            "https://github.com/Programmer-Red/LabStreamGate/releases",
                        );
                    }),
            ),
        )
        ...
        .child(
            ...
            settings_row(
                ...
                Button::new("support")
                    ...
                    .on_click(|_, _, _| {
                        RootView::open_link(
                            "https://github.com/Programmer-Red/LabStreamGate/issues",
                        );
                    }),
            ),
        )
            ...
            v_flex()
                ...
                .child(
                    div()
                        ...
                        .child(
                            "Based on WebSocketReflectorX by Reverier-Xu; adapted for TKKC Sec.",
                        ),
                )
                .child(
                    div()
                        ...
                        .text_color(muted_foreground)
                        .child("Original work (c) 2023 XDSEC; TKKC Sec modifications, MIT license."),
                ),
        )
}
